        ...
        <>
            <div className="main container">
                <div className="aboutMe">
                    <h1>About Me</h1>
                    <p>Hi! I’m a Front End developer whose passion for code sparked on an old laptop, bringing interfaces to life. Today, I craft websites with HTML, CSS, and React, turning designs into interactive masterpieces. Every project is a challenge—smooth animations, 30% faster load times—you name it. I love balancing beauty and function, drawing inspiration from mountains and music. My skills in Figma and VS Code create responsive layouts. Looking for fresh solutions? Let’s build something awesome together!</p>
                </div>
                <div className="trainingCenter">
                    <h1>Education</h1>
                    <div className="aboutTrainingCenter">
                        <div className="trainingCenterItem">
                            <h3>Proweb Training Center</h3>
                            <button className='trainingCenterBtn'>
                                <span>Finished</span>
                            </button>
                        </div>
                        <div className="trainingCenterExtra">
                            <div className="trainingCenterExtraItem">
                                <svg width="20" height="15" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
